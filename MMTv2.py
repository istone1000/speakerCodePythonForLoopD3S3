#Irene Stone
#Nov 2022
#Maths Multiplication Tutor v2 (MMT)
#This time the program should display a message informing the user that
#they were either correct or incorrect based on the value they enter.
